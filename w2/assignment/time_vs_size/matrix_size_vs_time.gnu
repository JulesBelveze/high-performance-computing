file1= "jacobi_time.txt"
file2 = "gauss_time.txt"
...
set key left top
set terminal jpeg
set output "time_vs_matrix_size.jpeg"


plot file1 using ($1):($2) with lines ls 3 title "jacobi", file2 using ($1):($2) with lines ls 4 title "gauss"
