...
#include "matrixlib.h"
/*------------------------------------------------- jacobi_iter -----
         |  Function jacobi_iter: PARALLELIZED VERSION: default schedule(static)
         *-------------------------------------------------------------------*/
...
// Start iteration
    #pragma omp parallel default(none) shared(m, n, mat_old, mat_new, k_max, threshold, f, delta, d_start, sum, temp_ptr) private(j, i, diff, k, d)
    {
